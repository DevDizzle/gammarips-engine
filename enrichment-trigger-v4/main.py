...
ENRICHED_SIGNALS_TABLE = f"{PROJECT_ID}.{DATASET}.overnight_signals_enriched_v4"
...
def write_enriched_signals(
    ...
    table_ref = bq_client.dataset(DATASET).table("overnight_signals_enriched_v4")
...
def enrichment_trigger():
    ...
    # V4: skip Firestore sync — webapp reads V3 only
